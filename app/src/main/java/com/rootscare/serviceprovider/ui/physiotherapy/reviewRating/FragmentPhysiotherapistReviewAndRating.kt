...
import com.rootscare.serviceprovider.ui.physiotherapy.reviewRating.adapter.AdapterPhysiotherapistUpdateReviewAndRating

class FragmentPhysiotherapistReviewAndRating :
    BaseFragment<FragmentNursesReviewAndRatingBinding, FragmentPhysiotherapistReviewAndRatingViewModel>(),
    FragmentPhysiotherapistReviewAndRatingNavigator {
    private var contactListAdapter: AdapterPhysiotherapistUpdateReviewAndRating? = null

    private var fragmentNursesReviewAndRatingBinding: FragmentNursesReviewAndRatingBinding? = null
    private var fragmentNursesReviewAndRatingViewModel: FragmentPhysiotherapistReviewAndRatingViewModel? = null
    override val bindingVariable: Int
        get() = BR.viewModel
    override val layoutId: Int
        get() = R.layout.fragment_nurses_review_and_rating
    override val viewModel: FragmentPhysiotherapistReviewAndRatingViewModel
        get() {
            fragmentNursesReviewAndRatingViewModel = ViewModelProviders.of(this).get(
                FragmentPhysiotherapistReviewAndRatingViewModel::class.java
            )
            return fragmentNursesReviewAndRatingViewModel as FragmentPhysiotherapistReviewAndRatingViewModel
        }

    companion object {
        fun newInstance(): FragmentPhysiotherapistReviewAndRating {
            val args = Bundle()
            val fragment = FragmentPhysiotherapistReviewAndRating()
...
//        val contactListAdapter = AdapterHospitalRecyclerviw(trainerList,context!!)
        contactListAdapter = AdapterPhysiotherapistUpdateReviewAndRating(requireContext())

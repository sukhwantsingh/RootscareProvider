...
import com.rootscare.serviceprovider.ui.caregiver.caregivermyappointment.subfragment.upcomingappointment.adapter.AdapterCaregiverUpcommingAppointment
...
class FragmentUpcommingAppointmentForCaregiver :
    ...
    private var contactListAdapter: AdapterCaregiverUpcommingAppointment? = null
    ...
    companion object {
        fun newInstance(): FragmentUpcommingAppointmentForCaregiver {
            val args = Bundle()
            val fragment = FragmentUpcommingAppointmentForCaregiver()
...
//        val contactListAdapter = AdapterHospitalRecyclerviw(trainerList,context!!)
        contactListAdapter = AdapterCaregiverUpcommingAppointment(upcomingAppointmentList, requireContext())

package com.rootscare.serviceprovider.ui.babySitter.babySitterUpdateReviewAndRating.adapter
...
class AdapterBabySitterUpdateReviewAndRating(internal var context: Context) :
    RecyclerView.Adapter<AdapterBabySitterUpdateReviewAndRating.ViewHolder>() {

...
class FragmentPhysiotherapistReviewAndRatingViewModel : BaseViewModel<FragmentPhysiotherapistReviewAndRatingNavigator>() {

    fun getReviewFromApi(getDoctorUpcomingAppointmentRequest: GetDoctorUpcommingAppointmentRequest) {
        val disposable = apiServiceWithGsonFactory.getPhysiotherapistReview(getDoctorUpcomingAppointmentRequest)

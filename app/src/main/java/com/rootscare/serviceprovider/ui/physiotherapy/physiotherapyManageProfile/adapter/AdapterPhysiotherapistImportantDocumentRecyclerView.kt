...
class AdapterPhysiotherapistImportantDocumentRecyclerView(
    val qualificationDataList: ArrayList<QualificationDataItem>?,
    internal var context: Context
) : RecyclerView.Adapter<AdapterPhysiotherapistImportantDocumentRecyclerView.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
    companion object {
        val TAG: String = AdapterPhysiotherapistImportantDocumentRecyclerView::class.java.simpleName
    }
    ...
    inner class ViewHolder(internal var itemVie: ItemDoctorImportantDocumentRecyclerviewBinding) : RecyclerView.ViewHolder(itemVie.root) {
        ...
        fun onBind(pos: Int) {
            ...
            if (qualificationDataList?.get(pos)?.qualificationCertificate != null && !TextUtils.isEmpty(qualificationDataList[pos].qualificationCertificate?.trim()) &&
                ...
                val imageUrl =
                    BaseMediaUrls.USERIMAGE.url + qualificationDataList[pos].qualificationCertificate

package com.rootscare.serviceprovider.ui.babySitter.babySitterUpdatePaymentHistory.adapter
...
class AdapterBabySitterUpdatePaymentHistoryRecyclerview(internal var context: Context) :
    RecyclerView.Adapter<AdapterBabySitterUpdatePaymentHistoryRecyclerview.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
    companion object {
        val TAG: String = AdapterBabySitterUpdatePaymentHistoryRecyclerview::class.java.simpleName
    }

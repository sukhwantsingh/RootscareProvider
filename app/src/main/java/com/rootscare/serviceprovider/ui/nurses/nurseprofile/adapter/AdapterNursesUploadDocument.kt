...
class AdapterNursesUploadDocument  ( internal var context: Context) : RecyclerView.Adapter<AdapterNursesUploadDocument.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
    companion object {
        val TAG: String = AdapterNursesUploadDocument::class.java.simpleName
    }
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val singleItemDashboardListingBinding = DataBindingUtil.inflate<ItemNursesImportantDocumentListRecyclerviewBinding>(
            LayoutInflater.from(context),
            R.layout.item_nurses_important_document_list_recyclerview, parent, false)
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemNursesImportantDocumentListRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {

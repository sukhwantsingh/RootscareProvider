...
class FragmentBabySitterUpdateReviewAndRatingViewModel : BaseViewModel<FragmentBabySitterUpdateReviewAndRatingNavigator>() {

    fun getReviewFromApi(getDoctorUpcomingAppointmentRequest: GetDoctorUpcommingAppointmentRequest) {
        val disposable = apiServiceWithGsonFactory.getBabySitterReview(getDoctorUpcomingAppointmentRequest)

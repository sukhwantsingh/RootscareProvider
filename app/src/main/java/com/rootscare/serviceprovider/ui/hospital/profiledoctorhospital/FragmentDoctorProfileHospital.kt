...
import com.rootscare.serviceprovider.ui.hospital.profiledoctorhospital.adapter.AdapterDoctorImportantDocumentrecyclerview
import com.rootscare.serviceprovider.ui.hospital.profiledoctorhospital.adapter.AdapterDoctordetailsReviewListRecyclerview
import com.rootscare.serviceprovider.ui.hospital.profiledoctorhospital.adapter.AdapterDoctordetailsSpecilityListRecyclerview
...
class FragmentDoctorProfileHospital : BaseFragment<FragmentDoctorProfileBinding, FragmentDoctorProfileViewModel>(),
    ...
    companion object {
        fun newInstance(id: String): FragmentDoctorProfileHospital {
            val args = Bundle()
            args.putString("id", id)
            val fragment = FragmentDoctorProfileHospital()
...
//        assert(fragmentDoctorProfileBinding!!.recyclerViewRootscareDoctorimportentDocument != null)
        ...
        val contactListAdapter = AdapterDoctorImportantDocumentrecyclerview(qualificationDataList, requireActivity())
...
//        assert(fragmentDoctorProfileBinding!!.recyclerViewRootscareDoctorReview != null)
        ...
        val contactListAdapter = AdapterDoctordetailsReviewListRecyclerview(reviewRatingList, requireContext())
        recyclerView.adapter = contactListAdapter
    }
    ...
    override fun successGetDoctorProfileResponse(getDoctorProfileResponse: GetDoctorProfileResponse?) {
        ...
        if (getDoctorProfileResponse?.code.equals("200")) {
            if (getDoctorProfileResponse?.result != null) {
                ...
                Glide
                    .with(this@FragmentDoctorProfileHospital)
...
//                    fragmentDoctorProfileBinding?.tvReviews?.text = getDoctorProfileResponse.result.avgRating + " " + "reviews"

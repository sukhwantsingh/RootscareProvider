...
class FragmentEditPhysiotherapyUpdateProfileViewModel : BaseViewModel<FragmentEditPhysiotherapyUpdateProfileNavigator>() {
...
//    }
    ...
    fun apiHitForUpdateProfileWithProfileAndCertificationImage(
        user_id: RequestBody, first_name: RequestBody, last_name: RequestBody, email: RequestBody,
        mobile_number: RequestBody, dob: RequestBody, gender: RequestBody, qualification: RequestBody? = null,
        passing_year: RequestBody? = null, institute: RequestBody? = null, description: RequestBody,
        experience: RequestBody, available_time: RequestBody, fees: RequestBody, department: RequestBody,
        ...
        val disposable = apiServiceWithGsonFactory.apiHitUpdateProfileWithImageAndCertificate(
            user_id, first_name, last_name, email, mobile_number, dob, gender, qualification, passing_year,
            institute, description, experience, available_time, fees, department, startTime, endTime, image,
            certificate
        )
            .subscribeOn(_scheduler_io)
            .observeOn(_scheduler_ui)

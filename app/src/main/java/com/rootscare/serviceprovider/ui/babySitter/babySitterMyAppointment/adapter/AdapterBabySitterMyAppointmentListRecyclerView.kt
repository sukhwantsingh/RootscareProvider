package com.rootscare.serviceprovider.ui.babySitter.babySitterMyAppointment.adapter
...
import com.rootscare.serviceprovider.ui.caregiver.caregivermyappointment.adapter.AdapterPhysiotherapyMyAppointmentListRecyclerView
import kotlinx.android.synthetic.main.item_nurses_my_appointment_list_recyclerview.view.*

class AdapterBabySitterMyAppointmentListRecyclerView(internal var context: Context) :
    RecyclerView.Adapter<AdapterBabySitterMyAppointmentListRecyclerView.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
    companion object {
        val TAG: String = AdapterPhysiotherapyMyAppointmentListRecyclerView::class.java.simpleName
    }

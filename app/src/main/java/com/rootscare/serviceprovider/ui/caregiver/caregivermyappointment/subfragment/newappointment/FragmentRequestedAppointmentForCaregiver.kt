...
import com.rootscare.serviceprovider.ui.caregiver.caregivermyappointment.subfragment.newappointment.adapter.AdapterRequestedAppointmentListForCaregiver
...
class FragmentRequestedAppointmentForCaregiver :
    BaseFragment<FragmentDoctorRequestedAppointmentBinding, FragmentRequestedAppointmentForNurseViewModel>(),
    FragmentRequestedAppointmentForNurseNavigator {
    private var lastPosition: Int? = null
    private var contactListAdapter: AdapterRequestedAppointmentListForCaregiver? = null
    ...
    companion object {
        fun newInstance(): FragmentRequestedAppointmentForCaregiver {
            val args = Bundle()
            val fragment = FragmentRequestedAppointmentForCaregiver()
...
//        val contactListAdapter = AdapterHospitalRecyclerviw(trainerList,context!!)
        contactListAdapter = AdapterRequestedAppointmentListForCaregiver(requestedappointmentList, requireContext())

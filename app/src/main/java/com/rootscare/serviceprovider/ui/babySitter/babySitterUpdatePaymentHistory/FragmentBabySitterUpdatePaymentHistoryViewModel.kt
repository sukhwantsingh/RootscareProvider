...
class FragmentBabySitterUpdatePaymentHistoryViewModel : BaseViewModel<FragmentBabySitterUpdatePaymentHistoryNavigator>() {

    fun getPaymentHistoryFromApi(getDoctorUpcomingAppointmentRequest: GetDoctorUpcommingAppointmentRequest) {
        val disposable = apiServiceWithGsonFactory.getPaymentHistoryForBabySitter(getDoctorUpcomingAppointmentRequest)

...
class FragmentRequestedAppointmentForNurse : BaseFragment<FragmentDoctorRequestedAppointmentBinding,
        FragmentRequestedAppointmentForNurseViewModel>(), FragmentRequestedAppointmentForNurseNavigator {
...
//        val contactListAdapter = AdapterHospitalRecyclerviw(trainerList,context!!)
        contactListAdapter = AdapterRequestedAppointmentListForNurse(requestedAppointmentList, requireContext())

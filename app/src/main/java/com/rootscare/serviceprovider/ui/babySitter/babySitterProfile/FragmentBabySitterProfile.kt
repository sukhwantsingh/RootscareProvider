...
class FragmentBabySitterProfile: BaseFragment<FragmentCaregiverProfileBinding, FragmentBabySitterProfileViewModel>(),
...
//        setUpViewSeeAllNursesCategorieslistingRecyclerview()
        ...
        fragmentCaregiverProfileBinding?.btnCaregiverEditProfile?.setOnClickListener {
            (activity as BabySitterHomeActivity).checkFragmentInBackStackAndOpen(
                ...
                FragmentEditDoctorProfile.newInstance("babysitter")
            )
        }

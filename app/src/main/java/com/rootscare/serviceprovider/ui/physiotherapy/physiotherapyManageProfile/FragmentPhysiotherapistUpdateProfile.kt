...
import com.rootscare.serviceprovider.ui.physiotherapy.physiotherapyManageProfile.adapter.AdapterPhysiotherapistImportantDocumentRecyclerView
import com.rootscare.serviceprovider.ui.physiotherapy.physiotherapyManageProfile.adapter.AdapterPhysiotherapyReviewListRecyclerview
...
class FragmentPhysiotherapistUpdateProfile : BaseFragment<FragmentNursesProfileBinding, FragmentPhysiotherapyUpdateProfileViewModel>(),
    FragmentPhysiotherapyUpdateProfileNavigator {
    private var fragmentNursesProfileBinding: FragmentNursesProfileBinding? = null
    private var fragmentNursesProfileViewModel: FragmentPhysiotherapyUpdateProfileViewModel? = null
    ...
    override val viewModel: FragmentPhysiotherapyUpdateProfileViewModel
        get() {
            fragmentNursesProfileViewModel = ViewModelProviders.of(this).get(
                FragmentPhysiotherapyUpdateProfileViewModel::class.java
            )
            return fragmentNursesProfileViewModel as FragmentPhysiotherapyUpdateProfileViewModel
        }


    companion object {
        fun newInstance(): FragmentPhysiotherapistUpdateProfile {
            val args = Bundle()
            val fragment = FragmentPhysiotherapistUpdateProfile()
...
//        setUpViewPrescriptionlistingRecyclerview()
        ...
        if (isNetworkConnected) {
            ...
            fragmentNursesProfileViewModel!!.apiPhysiotherapistProfile(commonUserIdRequest)
        } else {
...
//                FragmentEditPhysiotherapyUpdateProfile.newInstance("physiotherapy")
                FragmentEditDoctorProfile.newInstance("physiotherapy", fragmentNursesProfileViewModel?.appSharedPref?.loginUserId!!)
            )
        }
...
//        assert(fragmentNursesProfileBinding!!.recyclerViewRootscareDoctorimportentDocument != null)
        ...
        val contactListAdapter = AdapterPhysiotherapistImportantDocumentRecyclerView(qualificationDataList, requireActivity())
...
//        assert(fragmentNursesProfileBinding!!.recyclerViewRootscareDoctorReview != null)
        ...
        recyclerView.isNestedScrollingEnabled = false
        recyclerView.setHasFixedSize(false)
        val contactListAdapter = AdapterPhysiotherapyReviewListRecyclerview(reviewRatingList, requireContext())
        recyclerView.adapter = contactListAdapter
    }

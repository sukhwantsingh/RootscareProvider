package com.rootscare.serviceprovider.ui.hospital.profiledoctorhospital.editdoctoreprofile.adapter
...
class CertificateListAdapter  (internal var context: Context) : RecyclerView.Adapter<CertificateListAdapter.ViewHolder>() {
    companion object {
        val TAG: String = CertificateListAdapter::class.java.simpleName
    }

    internal lateinit var recyclerViewItemClickWithView: OnItemClikWithIdListener
    val qualificationDataList: ArrayList<QualificationDataItem> = ArrayList()

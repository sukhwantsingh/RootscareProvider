package com.rootscare.serviceprovider.ui.physiotherapy.reviewRating.adapter
...
class AdapterPhysiotherapistUpdateReviewAndRating(internal var context: Context) :
    RecyclerView.Adapter<AdapterPhysiotherapistUpdateReviewAndRating.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
    companion object {
        val TAG: String = AdapterPhysiotherapistUpdateReviewAndRating::class.java.simpleName
    }

...
class AdapterBabySitterUploadImportantDocument(internal var context: Context) :
    RecyclerView.Adapter<AdapterBabySitterUploadImportantDocument.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
    companion object {
        val TAG: String = AdapterBabySitterUploadImportantDocument::class.java.simpleName
    }

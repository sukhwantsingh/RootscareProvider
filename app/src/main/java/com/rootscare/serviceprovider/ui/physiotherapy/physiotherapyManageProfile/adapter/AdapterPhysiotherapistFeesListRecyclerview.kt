...
class AdapterPhysiotherapistFeesListRecyclerview(internal var context: Context) :
    RecyclerView.Adapter<AdapterPhysiotherapistFeesListRecyclerview.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
    companion object {
        val TAG: String = AdapterPhysiotherapistFeesListRecyclerview::class.java.simpleName
    }

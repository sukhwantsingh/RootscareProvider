package com.rootscare.serviceprovider.ui.hospital.hospitaluploadpathologyreport.subfragment.adapter
...
import com.rootscare.serviceprovider.databinding.ItemAllTestListRecyclerViewBinding
import kotlinx.android.synthetic.main.item_hospital_sample_collection_recyclerview.view.*

class AdapterUploadDocumentReportRecyclerview   ( internal var context: Context) : RecyclerView.Adapter<AdapterUploadDocumentReportRecyclerview.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
    companion object {
        val TAG: String = AdapterUploadDocumentReportRecyclerview::class.java.simpleName
    }
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val singleItemDashboardListingBinding = DataBindingUtil.inflate<ItemAllTestListRecyclerViewBinding>(
            LayoutInflater.from(context),
            R.layout.item_all_test_list_recycler_view, parent, false)
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemAllTestListRecyclerViewBinding) : RecyclerView.ViewHolder(itemView.root) {

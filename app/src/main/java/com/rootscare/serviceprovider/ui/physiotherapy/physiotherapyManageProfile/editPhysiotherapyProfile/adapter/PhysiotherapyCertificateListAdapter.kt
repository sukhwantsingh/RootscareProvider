package com.rootscare.serviceprovider.ui.physiotherapy.physiotherapyManageProfile.editPhysiotherapyProfile.adapter
...
class PhysiotherapyCertificateListAdapter(internal var context: Context) :
    RecyclerView.Adapter<PhysiotherapyCertificateListAdapter.ViewHolder>() {
    companion object {
        val TAG: String = PhysiotherapyCertificateListAdapter::class.java.simpleName
    }
...
//
        ...
        fun onBind(pos: Int) {
            ...
            localPosition = pos
            with(itemVie) {
                tvSerialNumber.setText("${localPosition + 1})")

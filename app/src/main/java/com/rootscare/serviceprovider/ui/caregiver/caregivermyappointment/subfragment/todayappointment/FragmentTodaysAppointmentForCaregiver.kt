...
class FragmentTodaysAppointmentForCaregiver :
    BaseFragment<FragmentDoctorTodaysAppointmentBinding, FragmentTodaysAppointmentForNurseViewModel>(),
...
//        val contactListAdapter = AdapterHospitalRecyclerviw(trainerList,context!!)
        contactListAdapter = AdapterCaregiverTodaysAppointmentRecyclerview(todaysAppointList, requireContext())

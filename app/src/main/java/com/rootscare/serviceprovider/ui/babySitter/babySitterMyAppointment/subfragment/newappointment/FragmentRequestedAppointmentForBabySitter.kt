...
import com.rootscare.serviceprovider.ui.babySitter.babySitterMyAppointment.subfragment.newappointment.adapter.AdapterRequestedAppointmentListForBabySitter
...
class FragmentRequestedAppointmentForBabySitter :
    BaseFragment<FragmentDoctorRequestedAppointmentBinding, FragmentRequestedAppointmentForBabySitterViewModel>(),
    FragmentRequestedAppointmentForBabySitterNavigator {
    private var lastPosition: Int? = null
    private var contactListAdapter: AdapterRequestedAppointmentListForBabySitter? = null
    ...
    private var fragmentRequestedAppointmentViewModel: FragmentRequestedAppointmentForBabySitterViewModel? = null
    override val bindingVariable: Int
        get() = BR.viewModel
    override val layoutId: Int
        get() = R.layout.fragment_doctor_requested_appointment
    override val viewModel: FragmentRequestedAppointmentForBabySitterViewModel
        get() {
            fragmentRequestedAppointmentViewModel = ViewModelProviders.of(this).get(
                FragmentRequestedAppointmentForBabySitterViewModel::class.java
            )
            return fragmentRequestedAppointmentViewModel as FragmentRequestedAppointmentForBabySitterViewModel
        }

    companion object {
        fun newInstance(): FragmentRequestedAppointmentForBabySitter {
            val args = Bundle()
            val fragment = FragmentRequestedAppointmentForBabySitter()
...
//        val contactListAdapter = AdapterHospitalRecyclerview(trainerList,context!!)
        contactListAdapter = AdapterRequestedAppointmentListForBabySitter(requestedAppointmentList, requireContext())

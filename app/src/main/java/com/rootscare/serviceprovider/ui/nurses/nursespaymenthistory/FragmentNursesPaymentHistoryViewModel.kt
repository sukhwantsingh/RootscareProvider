...
class FragmentNursesPaymentHistoryViewModel : BaseViewModel<FragmentNursesPaymentHistoryNavigator>() {

    fun getPaymentHistoryFromApi(getDoctorUpcommingAppointmentRequest: GetDoctorUpcommingAppointmentRequest) {
        val disposable = apiServiceWithGsonFactory.getPaymentHistoryForNurse(getDoctorUpcommingAppointmentRequest)

...
import com.rootscare.serviceprovider.ui.caregiver.caregivermyappointment.subfragment.upcomingappointment.FragmentUpcommingAppointmentForCaregiver
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        fragmentDoctorMyAppointmentBinding?.btnDoctorUpcommingAppointment?.setOnClickListener {
            (activity as CaregiverHomeActivity).checkFragmentInBackStackAndOpen(
                FragmentUpcommingAppointmentForCaregiver.newInstance()
            )
        }

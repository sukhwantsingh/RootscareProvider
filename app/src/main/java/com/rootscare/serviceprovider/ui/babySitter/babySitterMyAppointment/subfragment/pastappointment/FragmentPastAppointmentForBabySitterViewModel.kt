...
class FragmentPastAppointmentForBabySitterViewModel : BaseViewModel<FragmentPastAppointmentForBabySitterNavigator>() {
    fun apiDoctorAppointmentPastList(getDoctorUpcomingAppointmentRequest: GetDoctorUpcommingAppointmentRequest) {
        val disposable = apiServiceWithGsonFactory.apiBabySitterAppointmentPastList(getDoctorUpcomingAppointmentRequest)

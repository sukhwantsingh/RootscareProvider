package com.rootscare.serviceprovider.ui.caregiver.caregigerreviewandrating.adapter
...
class AdapterCaregiverReviewAndRatingRecyclerview ( internal var context: Context) : RecyclerView.Adapter<AdapterCaregiverReviewAndRatingRecyclerview.ViewHolder>() {

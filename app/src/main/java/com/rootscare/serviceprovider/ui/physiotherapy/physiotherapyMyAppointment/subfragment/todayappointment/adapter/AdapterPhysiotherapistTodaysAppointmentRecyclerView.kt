package com.rootscare.serviceprovider.ui.physiotherapy.physiotherapyMyAppointment.subfragment.todayappointment.adapter
...
class AdapterPhysiotherapistTodaysAppointmentRecyclerView(internal var todaysAppointList: ArrayList<ResultItem?>?, internal var context: Context) :
    RecyclerView.Adapter<AdapterPhysiotherapistTodaysAppointmentRecyclerView.ViewHolder>() {

...
class FragmentUpcommingAppointmentForBabySitterViewModel : BaseViewModel<FragmentUpcommingAppointmentForBabySitterNavigator>() {

    fun apiNurseUpComingAppointmentList(getDoctorUpcomingAppointmentRequest: GetDoctorUpcommingAppointmentRequest) {
        val disposable = apiServiceWithGsonFactory.apiBabySitterUpComingAppointmentList(getDoctorUpcomingAppointmentRequest)
    ...
    fun apiFilterNurseUpComingAppointmentList(filterAppointmentRequest: FilterAppointmentRequest) {
        val disposable = apiServiceWithGsonFactory.apiFilterBabySitterUpComingAppointmentList(filterAppointmentRequest)
            .subscribeOn(_scheduler_io)
            .observeOn(_scheduler_ui)
            .subscribe({ response ->
                if (response != null) {

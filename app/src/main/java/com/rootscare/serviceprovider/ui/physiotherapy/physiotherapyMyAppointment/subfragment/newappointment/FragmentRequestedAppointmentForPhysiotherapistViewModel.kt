...
class FragmentRequestedAppointmentForPhysiotherapistViewModel : BaseViewModel<FragmentRequestedAppointmentForPhysiotherapistNavigator>() {
    fun apiNurseAppointmentRequestList(getDoctorUpcomingAppointmentRequest: GetDoctorUpcommingAppointmentRequest) {
        val disposable = apiServiceWithGsonFactory.apiPhysiotherapistAppointmentRequestList(getDoctorUpcomingAppointmentRequest)

...
class AdapterPhysiotherapyMyAppointmentListRecyclerView  (internal var context: Context) : RecyclerView.Adapter<AdapterPhysiotherapyMyAppointmentListRecyclerView.ViewHolder>() {
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemNursesMyAppointmentListRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {
        ...
        init {
            itemView?.root?.crdview_nursesappoitment_list?.setOnClickListener(View.OnClickListener {

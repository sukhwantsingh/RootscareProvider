package com.rootscare.serviceprovider.ui.doctor.doctormyappointment.adapter
...
class AddapterDoctorMyAppointmentListRecyclerview(internal var context: Context) :
    RecyclerView.Adapter<AddapterDoctorMyAppointmentListRecyclerview.ViewHolder>() {
...
//
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val singleItemDashboardListingBinding = DataBindingUtil.inflate<ItemDoctorMyappointmentRecyclerviewBinding>(
            LayoutInflater.from(context),
            R.layout.item_doctor_myappointment_recyclerview, parent, false
        )
...
//        return trainerList!!.size
    ...
    inner class ViewHolder(itemView: ItemDoctorMyappointmentRecyclerviewBinding) : RecyclerView.ViewHolder(itemView.root) {

        private var localPosition: Int = 0

        init {
            itemView.root.crdview_doctorappoitment_list?.setOnClickListener {

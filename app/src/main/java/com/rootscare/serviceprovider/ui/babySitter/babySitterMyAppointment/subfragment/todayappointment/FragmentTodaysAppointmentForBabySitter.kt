...
import com.rootscare.serviceprovider.ui.babySitter.babySitterMyAppointment.subfragment.todayappointment.adapter.AdapterBabysitterTodaysAppointmentRecyclerview
...
class FragmentTodaysAppointmentForBabySitter :
    BaseFragment<FragmentDoctorTodaysAppointmentBinding, FragmentTodaysAppointmentForBabySitterViewModel>(),
    FragmentTodaysAppointmentForBabySitterNavigator {
    private var lastPosition: Int? = null
    private var uploadedImageItemPosition: Int? = null
    private var contactListAdapter: AdapterBabysitterTodaysAppointmentRecyclerview? = null
    ...
    private var fragmentTodaysAppointmentViewModel: FragmentTodaysAppointmentForBabySitterViewModel? = null
    override val bindingVariable: Int
        get() = BR.viewModel
    override val layoutId: Int
        get() = R.layout.fragment_doctor_todays_appointment
    override val viewModel: FragmentTodaysAppointmentForBabySitterViewModel
        get() {
            fragmentTodaysAppointmentViewModel = ViewModelProviders.of(this).get(
                FragmentTodaysAppointmentForBabySitterViewModel::class.java
            )
            return fragmentTodaysAppointmentViewModel as FragmentTodaysAppointmentForBabySitterViewModel
        }

    companion object {
        private val TAG = FragmentTodaysAppointmentForBabySitter::class.java.simpleName
        fun newInstance(): FragmentTodaysAppointmentForBabySitter {
            val args = Bundle()
            val fragment = FragmentTodaysAppointmentForBabySitter()
...
//            getDoctorUpcommingAppointmentRequest.userId="18"
            fragmentTodaysAppointmentViewModel!!.apiNurseTodayAppointmentList(getDoctorUpcomingAppointmentRequest)
        } else {
...
//        val contactListAdapter = AdapterHospitalRecyclerviw(trainerList,context!!)
        contactListAdapter = AdapterBabysitterTodaysAppointmentRecyclerview(todaysAppointList, requireContext())

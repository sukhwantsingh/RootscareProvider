...
class FragmentUpcomingAppointmentForBabySitter :
    BaseFragment<FragmentDoctorUpcomingAppointmentBinding, FragmentUpcommingAppointmentForBabySitterViewModel>(),
    FragmentUpcommingAppointmentForBabySitterNavigator {
    private var lastPosition: Int? = null
    private var contactListAdapter: AdapterBabySitterUpcommingAppointment? = null

    private var fragmentDoctorUpcomingAppointmentBinding: FragmentDoctorUpcomingAppointmentBinding? = null
    private var fragmentUpcommingAppointmentViewModel: FragmentUpcommingAppointmentForBabySitterViewModel? = null
    ...
    override val viewModel: FragmentUpcommingAppointmentForBabySitterViewModel
        get() {
            fragmentUpcommingAppointmentViewModel = ViewModelProviders.of(this).get(
                FragmentUpcommingAppointmentForBabySitterViewModel::class.java
            )
            return fragmentUpcommingAppointmentViewModel as FragmentUpcommingAppointmentForBabySitterViewModel
        }

    companion object {
        fun newInstance(): FragmentUpcomingAppointmentForBabySitter {
            val args = Bundle()
            val fragment = FragmentUpcomingAppointmentForBabySitter()
...
//            getDoctorUpcommingAppointmentRequest.userId="18"
            fragmentUpcommingAppointmentViewModel!!.apiNurseUpComingAppointmentList(getDoctorUpcomingAppointmentRequest)
        } else {
...
//        val contactListAdapter = AdapterHospitalRecyclerviw(trainerList,context!!)
        contactListAdapter = AdapterBabySitterUpcommingAppointment(upcomingAppointmentList, requireContext())

...
class AdapterBabySitterDetailsReviewListRecyclerView(
    val reviewRatingList: ArrayList<com.rootscare.data.model.response.caregiver.profileresponse.ReviewRatingItem?>?,
    internal var context: Context
) : RecyclerView.Adapter<AdapterBabySitterDetailsReviewListRecyclerView.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
//    val reviewRatingList: ArrayList<ReviewRatingItem?>?,
    companion object {
        val TAG: String = AdapterBabySitterDetailsReviewListRecyclerView::class.java.simpleName
    }

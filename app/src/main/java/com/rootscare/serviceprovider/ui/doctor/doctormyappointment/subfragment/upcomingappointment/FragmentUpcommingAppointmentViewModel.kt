...
class FragmentUpcommingAppointmentViewModel : BaseViewModel<FragmentUpcommingAppointmentNavigator>() {
    ...
    fun apiDoctorUpcomingAppointmentList(getDoctorUpcomingAppointmentRequest: GetDoctorUpcommingAppointmentRequest) {
//        val body = RequestBody.create(MediaType.parse("application/json"), "")
        val disposable = apiServiceWithGsonFactory.apidoctorupcomingappointmentlis(getDoctorUpcomingAppointmentRequest)

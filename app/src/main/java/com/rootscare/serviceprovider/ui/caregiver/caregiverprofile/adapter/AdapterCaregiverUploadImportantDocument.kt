...
class AdapterCaregiverUploadImportantDocument(internal var context: Context) :
    RecyclerView.Adapter<AdapterCaregiverUploadImportantDocument.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
    companion object {
        val TAG: String = AdapterCaregiverUploadImportantDocument::class.java.simpleName
    }

package com.rootscare.serviceprovider.ui.caregiver.caregiverpaymenthistory.adapter
...
class AdapterCaregiverPaymentHistoryRecyclerview(internal var context: Context) :
    RecyclerView.Adapter<AdapterCaregiverPaymentHistoryRecyclerview.ViewHolder>() {
    //    val trainerList: ArrayList<TrainerListItem?>?,
    companion object {
        val TAG: String = AdapterCaregiverPaymentHistoryRecyclerview::class.java.simpleName
    }
